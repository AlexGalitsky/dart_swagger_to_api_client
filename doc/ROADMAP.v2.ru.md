...
- [ ] **Оптимизация производительности**
  - [ ] Кэширование результатов парсинга спецификации
  - [ ] Оптимизация генерации больших спецификаций
  - [ ] Ленивая загрузка моделей в resolver

- [ ] **Улучшение валидации**
  - [ ] Более строгая валидация OpenAPI спецификаций
  - [ ] Предупреждения о deprecated фичах
  - [ ] Проверка совместимости версий OpenAPI
...
- [ ] **Расширение тестового покрытия**
  ...
  - [ ] Performance тесты для больших спецификаций
  - [ ] Тесты совместимости с различными версиями Dart

- [ ] **Интеграционные тесты**
  - [ ] Тесты с реальными API (опционально)
  - [ ] Тесты с различными OpenAPI версиями
...
- [ ] **Подготовка к публикации**
  ...
  - [ ] Проверка совместимости с последними версиями Dart
  - [ ] Создание changelog
...
### 1.1.1 Расширенная поддержка параметров

- [ ] **Массивы параметров**
  - [ ] Поддержка `array` типов в query параметрах
  - [ ] Правильная сериализация массивов (comma-separated, pipe-separated, etc.)
  - [ ] Поддержка `explode` опции

- [ ] **Сложные типы параметров**
  - [ ] Поддержка `object` типов в query параметрах
  - [ ] Поддержка вложенных объектов
  - [ ] Deep object serialization

- [ ] **Параметры на уровне path**
  - [ ] Поддержка параметров, определенных на уровне path item
  - [ ] Правильное наследование параметров

### 1.1.2 Расширенная поддержка requestBody

- [ ] **Множественные content types**
  - [ ] Автоматический выбор content type на основе данных
  - [ ] Поддержка `text/plain`, `text/html`, `application/xml`
  - [ ] Поддержка кастомных content types

- [ ] **Условные requestBody**
...
- [ ] **Автоматическая генерация**
  - [ ] Builder для автоматической генерации в build pipeline
...
- [ ] **Pagination helpers**
  - [ ] Автоматическая генерация pagination методов
...
- [ ] **Полная поддержка OpenAPI 3.1**
  - [ ] Все новые фичи OpenAPI 3.1
  - [ ] Webhooks support
  - [ ] Расширенная поддержка JSON Schema
