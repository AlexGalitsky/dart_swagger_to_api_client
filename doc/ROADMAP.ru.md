...
- ✅ Базовая поддержка пагинации:
  - ✅ Обнаружение типичных паттернов (query `page`/`offset` + `limit`/`per_page`/`page_size`).
...
- **0.6.0 Advanced DX** ⚠️ Частично реализовано
  - ✅ Watch‑режим (`--watch`) для авто‑регенерации клиента:
    - ✅ Отслеживание изменений спецификации и конфигурационного файла
    - ✅ Автоматическая регенерация при изменениях (с debounce 500ms)
    - ✅ Автоматическая перезагрузка конфигурации при изменении config файла
    - ✅ Поддержка всех CLI флагов в watch-режиме
